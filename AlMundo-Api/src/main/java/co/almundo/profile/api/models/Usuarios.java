...
/**
 * Clase Modelo de la tabla ALMUNDO_USUARIOS
...
@Entity
@SequenceGenerator(name = "usuarios-gen",sequenceName = "almundo_usuarios_id_usuario_seq",initialValue = 1, allocationSize = 1)
@Table(name = "ALMUNDO_USUARIOS")
