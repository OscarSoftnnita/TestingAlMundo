...
/**
 * Clase Modelo de la tabla ALMUNDO_PARAMETROS
 ...
 */
@Entity
@SequenceGenerator(name = "parametros-gen", sequenceName = "almundo_parametros_id_parametro_seq", initialValue = 1, allocationSize = 1)
@Table(name = "ALMUNDO_PARAMETROS")
