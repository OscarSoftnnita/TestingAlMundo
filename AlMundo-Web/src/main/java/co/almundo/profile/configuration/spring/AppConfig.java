package co.almundo.profile.configuration.spring;

import co.almundo.profile.configuration.dom.ISesionActive;
import co.almundo.profile.configuration.dom.impl.ISesionActiveImpl;
...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = "co.almundo.profile")
