 ...
 * DE ALMUNDO.COM
 */
package co.almundo.profile.impl.proxys;
...
import co.almundo.profile.impl.configuration.hibernate.ContextProvider;
import co.almundo.profile.impl.configuration.hibernate.ServicesReferencesMapping;
